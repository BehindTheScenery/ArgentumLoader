...
//            int fade = 0xff;
    ...
    public static RenderElement denis(SimpleFont font) {
        return new RenderElement(RenderElement.initializeTexture("denis_master_herobrine.png", 453000, 2, (bb, context, size, frame) -> {
            int framecount = size[1] / size[0];
